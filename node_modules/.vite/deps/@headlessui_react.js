...
function o2() {
  let n6 = [], r10 = { addEventListener(e6, t15, s17, a11) {
    ...
    return n6.push(e6), () => {
      ...
      if (t15 >= 0) for (let s17 of n6.splice(t15, 1)) s17();
    };
  }, dispose() {
    for (let e6 of n6.splice(0)) e6();
  } };
  return r10;
}
...
function O(e6, r10, { sorted: t15 = true, relativeTo: l10 = null, skipElements: o11 = [] } = {}) {
  ...
  let E6 = (() => {
    ...
    if (r10 & 1) return 0;
    if (r10 & 2) return Math.max(0, n6.indexOf(l10)) - 1;
    if (r10 & 4) return Math.max(0, n6.indexOf(l10)) + 1;
    if (r10 & 8) return n6.length - 1;
    throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
  })(), p9 = r10 & 32 ? { preventScroll: true } : {}, d15 = 0, a11 = n6.length, u8;
  do {
    if (d15 >= a11 || d15 + a11 <= 0) return 0;
    let s17 = x6 + d15;
    if (r10 & 16) s17 = (s17 + a11) % a11;
    else {
      if (s17 < 0) return 3;
      if (s17 >= a11) return 1;
    }
...
function L(m9, E6, c13 = true) {
  ...
  function f13(e6, o11) {
    if (!i11.current || e6.defaultPrevented) return;
    ...
    if (n6 !== null && n6.getRootNode().contains(n6)) {
      for (let r10 of l10) {
        ...
        if (t15 != null && t15.contains(n6) || e6.composed && e6.composedPath().includes(t15)) return;
      }
...
function y2(...t15) {
  ...
  let c13 = o4((e6) => {
    for (let o11 of n6.current) o11 != null && (typeof o11 == "function" ? o11(e6) : o11.current = e6);
  });
...
function F2({ container: e6, accept: t15, walk: r10, enabled: c13 = true }) {
  ...
  (0, import_react12.useEffect)(() => {
    ...
    for (; u8.nextNode(); ) p9(u8.currentNode);
  }, [e6, c13, o11, l10]);
}
...
function X({ ourProps: r10, theirProps: t15, slot: e6, defaultTag: a11, features: s17, visible: n6 = true, name: f13 }) {
  let o11 = N2(t15, r10);
  if (n6) return c3(o11, e6, a11, f13);
  let u8 = s17 != null ? s17 : 0;
  if (u8 & 2) {
    let { static: l10 = false, ...p9 } = o11;
    if (l10) return c3(p9, e6, a11, f13);
  }
  if (u8 & 1) {
...
function c3(r10, t15 = {}, e6, a11) {
  ...
  if (t15) {
    let i11 = false, m9 = [];
    for (let [y7, d15] of Object.entries(t15)) typeof d15 == "boolean" && (i11 = true), d15 === true && m9.push(y7);
    i11 && (p9["data-headlessui-state"] = m9.join(" "));
  }
  if (s17 === import_react13.Fragment && Object.keys(R(o11)).length > 0) {
    if (!(0, import_react13.isValidElement)(l10) || Array.isArray(l10) && l10.length > 1) throw new Error(['Passing props on "Fragment"!', "", `The current component <${a11} /> is rendering a "Fragment".`, "However we need to passthrough the following props:", Object.keys(o11).map((d15) => `  - ${d15}`).join(`
...
function w2(...r10) {
  return { ref: r10.every((t15) => t15 == null) ? void 0 : (t15) => {
    for (let e6 of r10) e6 != null && (typeof e6 == "function" ? e6(t15) : e6.current = t15);
  } };
}
function N2(...r10) {
  var a11;
  ...
  let t15 = {}, e6 = {};
  for (let s17 of r10) for (let n6 in s17) n6.startsWith("on") && typeof s17[n6] == "function" ? ((a11 = e6[n6]) != null || (e6[n6] = []), e6[n6].push(s17[n6])) : t15[n6] = s17[n6];
  if (t15.disabled || t15["aria-disabled"]) return Object.assign(t15, Object.fromEntries(Object.keys(e6).map((s17) => [s17, void 0])));
  for (let s17 in e6) Object.assign(t15, { [s17](n6, ...f13) {
    let o11 = e6[s17];
    for (let u8 of o11) {
      if ((n6 instanceof Event || (n6 == null ? void 0 : n6.nativeEvent) instanceof Event) && n6.defaultPrevented) return;
      u8(n6, ...f13);
    }
  } });
  return t15;
...
function R(r10) {
  ...
  for (let e6 in t15) t15[e6] === void 0 && delete t15[e6];
  return t15;
}
function g(r10, t15 = []) {
  let e6 = Object.assign({}, r10);
  for (let a11 of t15) a11 in e6 && delete e6[a11];
  return e6;
}
...
function r3(n6) {
  ...
  for (; e6 && !(e6 instanceof HTMLFieldSetElement); ) e6 instanceof HTMLLegendElement && (l10 = e6), e6 = e6.parentElement;
...
function e3(n6 = {}, r10 = null, t15 = []) {
  for (let [i11, o11] of Object.entries(n6)) f3(t15, s7(r10, i11), o11);
  return t15;
}
function s7(n6, r10) {
...
function f3(n6, r10, t15) {
  if (Array.isArray(t15)) for (let [i11, o11] of t15.entries()) f3(n6, s7(r10, i11.toString()), o11);
  else t15 instanceof Date ? n6.push([r10, t15.toISOString()]) : typeof t15 == "boolean" ? n6.push([r10, t15 ? "1" : "0"]) : typeof t15 == "string" ? n6.push([r10, t15]) : typeof t15 == "number" ? n6.push([r10, `${t15}`]) : t15 == null ? n6.push([r10, ""]) : e3(t15, r10, n6);
}
function p2(n6) {
  var t15;
  let r10 = (t15 = n6 == null ? void 0 : n6.form) != null ? t15 : n6.closest("form");
  if (r10) {
    for (let i11 of r10.elements) if (i11.tagName === "INPUT" && i11.type === "submit" || i11.tagName === "BUTTON" && i11.type === "submit" || i11.nodeName === "INPUT" && i11.type === "image") {
      i11.click();
      return;
    }
  }
...
function m3(u8, t15) {
  ...
  (0, import_react16.useEffect)(() => {
    let o11 = [...e6.current];
    for (let [n6, a11] of t15.entries()) if (e6.current[n6] !== a11) {
      let l10 = r10(t15, o11);
...
var He = { [1](t15) {
  ...
  var e6;
  if ((e6 = t15.dataRef.current) != null && e6.disabled || t15.comboboxState === 0) return t15;
  ...
  var i11, b4, n6, d15;
  if ((i11 = t15.dataRef.current) != null && i11.disabled || (b4 = t15.dataRef.current) != null && b4.optionsRef.current && !((n6 = t15.dataRef.current) != null && n6.optionsPropsRef.current.static) && t15.comboboxState === 1) return t15;
  let e6 = re(t15);
...
function Ke(t15, l10) {
  ...
  let g4 = (0, import_react18.useRef)(false), m9 = o4(() => {
    ...
    switch (f13.current = true, a11.key) {
      case o8.Backspace:
      case o8.Delete:
        if (o11.mode !== 0 || !o11.nullable) return;
        ...
        break;
      case o8.Enter:
        if (f13.current = false, o11.comboboxState !== 0 || g4.current) return;
      ...
      case o8.Tab:
        if (f13.current = false, o11.comboboxState !== 0) return;
    ...
    if (o11.labelId) return [o11.labelId].join(" ");
...
function $e(t15, l10) {
  ...
  let e6 = H2("Combobox.Button"), r10 = $("Combobox.Button"), i11 = y2(e6.buttonRef, l10), b4 = I(), { id: n6 = `headlessui-combobox-button-${b4}`, ...d15 } = t15, o11 = p(), u8 = o4((m9) => {
    ...
    if (r3(m9.currentTarget)) return m9.preventDefault();
    e6.comboboxState === 0 ? r10.closeCombobox() : (m9.preventDefault(), r10.openCombobox()), o11.nextFrame(() => {
      var x6;
      return (x6 = e6.inputRef.current) == null ? void 0 : x6.focus({ preventScroll: true });
    });
  }), f13 = i2(() => {
    if (e6.labelId) return [e6.labelId, n6].join(" ");
...
function oo(t15, l10) {
  ...
  l(() => {
    if (!d15.__demoMode) return;
    let O4 = o2();
    return O4.requestAnimationFrame(() => {
      m9.current = true;
    }), O4.dispose;
  }, []), l(() => {
    if (d15.comboboxState !== 0 || !u8 || !m9.current || d15.activationTrigger === 0) return;
    let O4 = o2();
    return O4.requestAnimationFrame(() => {
      var a11, I8;
...
// node_modules/@headlessui/react/dist/components/focus-trap/focus-trap.js
function P(t15) {
  if (!t15) return /* @__PURE__ */ new Set();
  if (typeof t15 == "function") return new Set(t15());
  let n6 = /* @__PURE__ */ new Set();
  for (let e6 of t15.current) e6.current instanceof HTMLElement && n6.add(e6.current);
  return n6;
}
var J = "div";
...
function S3(t15, n6) {
  for (let e6 of t15) if (e6.contains(n6)) return true;
  return false;
}
...
function H3(u8) {
  let a11 = l5(), o11 = (0, import_react26.useContext)(c7), e6 = n4(u8), [l10, n6] = (0, import_react26.useState)(() => {
    if (!a11 && o11 !== null || s.isServer) return null;
...
function _2(u8, a11) {
  ...
  return l(() => {
    if (f13.current = false, !(!t15 || !r10)) return t15.contains(r10) || (r10.setAttribute("data-headlessui-portal", ""), t15.appendChild(r10)), () => {
      f13.current = true, t3(() => {
        var p9;
...
function p6() {
  ...
  return { before() {
    ...
    l10.addEventListener(r10, "click", (e6) => {
      if (e6.target instanceof HTMLElement) try {
...
function m7(e6) {
  let n6 = {};
  for (let t15 of e6) Object.assign(n6, t15(n6));
  return n6;
}
...
a8.subscribe(() => {
  ...
  for (let [t15] of e6) n6.set(t15, t15.documentElement.style.overflow);
...
function p7(e6, r10, n6) {
  ...
  return l(() => {
    if (!(!e6 || !r10)) return a8.dispatch("PUSH", e6, n6), () => a8.dispatch("POP", e6, n6);
  }, [r10, e6]), i11;
}
...
function h6(r10, l10 = true) {
  l(() => {
    ...
    function a11() {
      ...
      if (i11 === 1 ? t13.delete(e6) : t13.set(e6, i11 - 1), i11 !== 1) return;
      let n6 = u6.get(e6);
...
function Ie(t15, e6) {
  ...
  if (!U5 && !N5) throw new Error("You have to provide an `open` and an `onClose` prop to the `Dialog` component.");
  if (!U5) throw new Error("You provided an `onClose` prop to the `Dialog`, but forgot an `open` prop.");
  if (!N5) throw new Error("You provided an `open` prop to the `Dialog`, but forgot an `onClose` prop.");
  if (typeof n6 != "boolean") throw new Error(`You provided an \`open\` prop to the \`Dialog\`, but the value is not a boolean. Received: ${n6}`);
  if (typeof l10 != "function") throw new Error(`You provided an \`onClose\` prop to the \`Dialog\`, but the value is not a function. Received: ${l10}`);
  let u8 = n6 ? 0 : 1, [E6, Z6] = (0, import_react29.useReducer)(_e, { titleId: null, descriptionId: null, panelRef: (0, import_react29.createRef)() }), A7 = o4(() => l10(false)), Y7 = o4((r10) => Z6({ type: 0, id: r10 })), k2 = l2() ? c13 ? false : u8 === 0 : false, x6 = P5 > 1, $7 = (0, import_react29.useContext)(M4) !== null, ee4 = x6 ? "parent" : "leaf", W = i11 !== null ? (i11 & d4.Closing) === d4.Closing : false, te4 = /* @__PURE__ */ (() => $7 || W ? false : k2)(), oe4 = (0, import_react29.useCallback)(() => {
    var r10, f13;
  ...
  h6(oe4, te4);
  let re6 = /* @__PURE__ */ (() => x6 ? true : k2)(), ne6 = (0, import_react29.useCallback)(() => {
    var r10, f13;
  ...
  let ie4 = /* @__PURE__ */ (() => !(W || u8 !== 0 || $7))();
  xe2(p9, ie4, H8), (0, import_react29.useEffect)(() => {
    if (u8 !== 0 || !m9.current) return;
...
function Be(t15, e6) {
  let o11 = I(), { id: s17 = `headlessui-dialog-overlay-${o11}`, ...n6 } = t15, [{ dialogState: l10, close: d15 }] = S7("Dialog.Overlay"), c13 = y2(e6), D8 = o4((i11) => {
    if (i11.target === i11.currentTarget) {
      if (r3(i11.currentTarget)) return i11.preventDefault();
...
function Ue2(t15, e6) {
  ...
  (0, import_react29.useEffect)(() => {
    if (d15.panelRef.current === null) throw new Error("A <Dialog.Backdrop /> component is being used, but a <Dialog.Panel /> component is missing.");
  }, [d15.panelRef]);
...
function ne(e6, n6) {
  ...
  (0, import_react31.useEffect)(() => {
    if (!s17) return t15({ type: 2, buttonId: u8 }), () => {
  ...
  let D8 = o4((r10) => {
    var p9;
    if (s17) {
      if (l10.disclosureState === 1) return;
      switch (r10.key) {
        case o8.Space:
        case o8.Enter:
...
var Ne3 = { [1](e6) {
  ...
  if (e6.dataRef.current.disabled || e6.listboxState === 0) return e6;
  ...
  var l10;
  if (e6.dataRef.current.disabled || e6.listboxState === 1) return e6;
...
function We3(e6, a11) {
  ...
  let o11 = I(), { id: r10 = `headlessui-listbox-button-${o11}`, ...l10 } = e6, t15 = B("Listbox.Button"), p9 = U3("Listbox.Button"), u8 = y2(t15.buttonRef, a11), i11 = p(), b4 = o4((c13) => {
    ...
    if (r3(c13.currentTarget)) return c13.preventDefault();
    ...
    if (t15.labelId) return [t15.labelId, r10].join(" ");
...
function qe2(e6, a11) {
  ...
  let P5 = o4((n6) => {
    switch (b4.dispose(), n6.key) {
      case o8.Space:
        if (t15.searchQuery !== "") return n6.preventDefault(), n6.stopPropagation(), p9.search(n6.key);
      case o8.Enter:
...
function Ze2(e6, a11) {
  ...
  l(() => {
    if (u8.listboxState !== 0 || !b4 || u8.activationTrigger === 0) return;
    let y7 = o2();
  ...
  let L5 = o4((y7) => {
    if (l10) return y7.preventDefault();
    ...
    if (l10) return i11.goToOption(a2.Nothing);
...
function Me2(e6, u8) {
  ...
  let r10 = I(), { id: i11 = `headlessui-menu-button-${r10}`, ...s17 } = e6, [t15, o11] = F5("Menu.Button"), a11 = y2(t15.buttonRef, u8), l10 = p(), m9 = o4((p9) => {
    ...
    if (r3(p9.currentTarget)) return p9.preventDefault();
...
function Ae(e6, u8) {
  ...
  let g4 = o4((n6) => {
    ...
    switch (m9.dispose(), n6.key) {
      case o8.Space:
        if (t15.searchQuery !== "") return n6.preventDefault(), n6.stopPropagation(), o11({ type: 3, value: n6.key });
      case o8.Enter:
...
function Ee(e6, u8) {
  ...
  l(() => {
    if (o11.menuState !== 0 || !l10 || o11.activationTrigger === 0) return;
    let c13 = o2();
  ...
  let g4 = o4(() => {
    ...
    if (s17) return c13.preventDefault();
    a11({ type: 1 }), D(o11.buttonRef.current);
  }), I8 = o4(() => {
    if (s17) return a11({ type: 2, focus: a2.Nothing });
...
function De(o11, l10) {
  ...
  let s17 = (0, import_react34.useRef)(null), R3 = y2(l10, T2((e6) => {
    ...
    if (!a11 || !f13) return false;
    for (let N5 of document.querySelectorAll("body > *")) if (Number(N5 == null ? void 0 : N5.contains(a11)) ^ Number(N5 == null ? void 0 : N5.contains(f13))) return true;
  ...
  let [p9] = (0, import_react34.useState)(() => Symbol()), P5 = y2(v4, l10, i11 ? null : (e6) => {
    ...
    if (i11) {
      ...
      case o8.Enter:
        ...
        break;
      case o8.Escape:
        if (r10.popoverState !== 0) return T7 == null ? void 0 : T7(r10.buttonId);
        if (!v4.current || y7 != null && y7.activeElement && !v4.current.contains(y7.activeElement)) return;
...
function Ue4(o11, l10) {
  ...
  let P5 = C(), S10 = (() => P5 !== null ? (P5 & d4.Open) === d4.Open : t15.popoverState === 0)(), y7 = o4((u8) => {
    ...
    switch (u8.key) {
      case o8.Escape:
        if (t15.popoverState !== 0 || !d15.current || p9 != null && p9.activeElement && !d15.current.contains(p9.activeElement)) return;
  ...
  (0, import_react34.useEffect)(() => {
    ...
    if (!C4 || t15.popoverState !== 0 || !d15.current) return;
  ...
  let x6 = (0, import_react34.useMemo)(() => ({ open: t15.popoverState === 0, close: v4 }), [t15, v4]), O4 = { ref: i11, id: R3, onKeyDown: y7, onBlur: C4 && t15.popoverState === 0 ? (u8) => {
    ...
    function m9() {
      u(L5.current, { [s11.Forwards]: () => {
        var A7;
        if (!t15.button) return;
        let E6 = f(), c13 = E6.indexOf(t15.button), B4 = E6.slice(0, c13 + 1), n6 = [...E6.slice(c13 + 1), ...B4];
        for (let g4 of n6.slice()) if (g4.dataset.headlessuiFocusGuard === "true" || (A7 = t15.panel) != null && A7.contains(g4)) {
...
function We4(o11, l10) {
  let s17 = (0, import_react34.useRef)(null), R3 = y2(s17, l10), [C4, r10] = (0, import_react34.useState)([]), t15 = o4((p9) => {
    ...
    for (let P5 of C4) P5.buttonId.current !== p9 && P5.close();
...
function d12(n6) {
  ...
  if (!t15) throw new Error("You must wrap your component in a <StableCollection>");
...
function f11() {
  ...
  if (!n6) return Symbol();
  let t15 = [], e6 = n6;
  for (; e6; ) t15.push(e6.index), e6 = e6.return;
  return "$." + t15.join(".");
}
...
var ce3 = { [0](e6, n6) {
  ...
  var r10;
  if (e6.tabs.includes(n6.tab)) return e6;
...
function me3(e6, n6) {
  ...
  l(() => {
    ...
    if (C4.current === void 0 || l10.tabs.length <= 0) return;
  ...
  return import_react40.default.createElement(C3, null, import_react40.default.createElement($6.Provider, { value: N5 }, import_react40.default.createElement(X7.Provider, { value: E6 }, E6.tabs.length <= 0 && import_react40.default.createElement(p8, { onFocus: () => {
    var p9, I8;
    for (let a11 of x6.current) if (((p9 = a11.current) == null ? void 0 : p9.tabIndex) === 0) return (I8 = a11.current) == null || I8.focus(), true;
    return false;
...
function xe7(e6, n6) {
  ...
  let x6 = m9 === R3, E6 = o4((a11) => {
    ...
    } })) === N.Success) return a11.preventDefault();
...
function l9(r10) {
  let e6 = { called: false };
  return (...t15) => {
    if (!e6.called) return e6.called = true, r10(...t15);
  };
}
...
function D7({ container: i11, direction: t15, classes: o11, onStart: s17, onStop: u8 }) {
  ...
  l(() => {
    ...
    c13.add(e6.dispose);
    let n6 = i11.current;
    if (n6 && r10.current !== "idle" && a11.current) return e6.dispose(), s17.current(r10.current), e6.add(y6(n6, o11.current, r10.current === "enter", () => {
...
function Ee3() {
  ...
  if (n6 === null) throw new Error("A <Transition.Child /> is used but it is missing a parent <Transition /> or <Transition.Root />.");
  return n6;
}
function be3() {
...
function re5(n6) {
  var r10;
  let t15 = {};
  for (let o11 of xe8) t15[o11] = (r10 = n6[o11]) != null ? r10 : Se5;
  return t15;
}
function Pe3(n6) {
...
function ye4(n6, t15) {
  ...
  (0, import_react41.useEffect)(() => {
    if (k2 && g4 === "visible" && e6.current === null) throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [e6, g4, k2]);
...
function Ne5(n6, t15) {
  ...
  l2();
  let m9 = C();
  if (r10 === void 0 && m9 !== null && (r10 = (m9 & d4.Open) === d4.Open), ![true, false].includes(r10)) throw new Error("A <Transition /> is used but it is missing a `show={true | false}` prop.");
